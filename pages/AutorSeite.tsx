  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'Person',
        name: 'Thomas Sander',
        url: 'https://rehatechnik-stellenangebote.de/autor/thomas-sander',
        jobTitle: 'Gründer & Geschäftsführer',
        worksFor: {
          '@type': 'Organization',
          name: 'Social Media Venture GmbH',
          url: 'https://rehatechnik-stellenangebote.de',
        },
        description: 'HR-Tech-Experte und Gründer spezialisierter Jobportale für Fachkräfte in Deutschland.',
        knowsAbout: ['HR-Tech', 'Recruiting', 'Jobportale', 'Rehatechnik', 'Personalwesen'],
            ...
            <div className="p-8 md:p-12 space-y-10">
              ...
              <section>
                ...
                <div className="text-slate-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    Unter seiner Leitung ist rehatechnik-stellenangebote.de zu einer führenden Anlaufstelle für Rehatechnik-Stellenangebote in Deutschland, Österreich und der Schweiz geworden.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: 'Rehatechnik-Branche', desc: 'Branchenspezifisches Know-how und Netzwerk im Rehatechnik-Bereich' },
